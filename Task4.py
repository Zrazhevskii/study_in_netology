...
def get_avr_rate_by_course(members, course):
    sum_rate = 0
    len_rate = 0
    for member in members:
        if course in member.grades:
            sum_rate += sum(member.grades[course])
            len_rate += len(member.grades[course])
    if len_rate:
        return round(sum_rate/len_rate, 1)
    return 0
...
print(get_avr_rate_by_course([best_student, best_student2], 'Python'))
print(get_avr_rate_by_course([cool_lecturer2, cool_lecturer], 'Python'))
